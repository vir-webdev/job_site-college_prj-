...
export default function Notification() {
  ...
  const { user, isAuthorized, isAuthorizedEmp } = useContext(Context);
  ...
  return (
    <>
      ...
      <div className='notification-body'>
        <div class="container notification-conatiner">
                    ...
                    <>
                      ...
                      {applications.length <= 0 ? (
                        ...
                        applications.map((element) => {
                          return (
                            <div class="msg selected-bg anim-y" key={element._id}>
                              <input type="checkbox" name="msg" id="mail1" class="mail-choice" checked />
                              <label for="mail1"></label>
                              <div class="msg-content">
                                <div class="msg-title">{element.name}</div>
                                <div class="msg-date">{element.email}</div>
                              </div>
              ...
              <div class="mail-detail">
                ...
                <div class="mail-contents">
                  <div class="mail-contents-subject">
                    ...
                    <div class="mail-contents-title">Write an article about </div>
                  </div>
                  <div class="mail">
                    <div class="mail-time">
                    ...
                    <div class="mail-checklist">
                      ...
                      <label for="mail30">Natalie update on</label>
                    ...
                    <div class="mail-doc">
                      <div class="mail-doc-wrapper">
                        ...
                        <div class="mail-doc-detail">
                          <div class="mail-doc-name">Resume.pdf</div>
